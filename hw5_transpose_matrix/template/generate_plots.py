...
def plot_exp1():
    ...
    fig.tight_layout()
    out = os.path.join(FIGURES_DIR, "fig1_seq_time_vs_n.pdf")
...
def plot_exp2():
    ...
    fig.tight_layout()
    out = os.path.join(FIGURES_DIR, "fig2_fine_time_vs_threads.pdf")
    fig.savefig(out, bbox_inches="tight")
    print(f"Saved {out}")
    plt.close(fig)
...
def plot_exp3():
    ...
    ax.legend()
    fig.tight_layout()
    out = os.path.join(FIGURES_DIR, "fig3_coarse_time_vs_threads.pdf")
    fig.savefig(out, bbox_inches="tight")
    print(f"Saved {out}")
    plt.close(fig)
...
def plot_exp4():
    ...
    ax.legend()
    fig.tight_layout()
    out = os.path.join(FIGURES_DIR, "fig4_speedup_fine_vs_coarse.pdf")
    fig.savefig(out, bbox_inches="tight")
    print(f"Saved {out}")
    plt.close(fig)
...
def plot_exp5():
    ...
    ax.legend()
    fig.tight_layout()
    out = os.path.join(FIGURES_DIR, "fig5_speedup_vs_n.pdf")
    fig.savefig(out, bbox_inches="tight")
    print(f"Saved {out}")
    plt.close(fig)
...
if __name__ == "__main__":
    ...
    print("Include them in your report with \\includegraphics{figures/<name>.pdf}")
